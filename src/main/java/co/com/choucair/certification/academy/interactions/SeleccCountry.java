...
public class SeleccCountry implements Interaction {
    private Target lista;
    private String opcion;

    public SeleccCountry(Target lista,String opcion) {
        this.lista = lista;
        this.opcion = opcion;
    }
    @Override
    ...
    public static SeleccCountry laLista(Target lista, String opcion) {
        return new SeleccCountry(lista,opcion);
    }
}
