...
public class SeleccSkill implements Interaction {
    private Target lista;
    private String opcion;

    public SeleccSkill(Target lista,String opcion) {
        this.lista = lista;
        this.opcion = opcion;
    }
    @Override
    ...
    public static SeleccSkill laLista(Target lista, String opcion) {
        return new SeleccSkill(lista,opcion);
    }
}
